/* [project]/node_modules/grapesjs/dist/css/grapes.min.css [app-client] (css) */
.CodeMirror {
  color: #000;
  direction: ltr;
  height: 300px;
...
.cm-s-hopscotch span.cm-atom, .cm-s-hopscotch span.cm-number {
  color: #c85e7c;
}
...
:root {
  ...
  --gjs-main-dark-color: #0003;
  --gjs-secondary-dark-color: #0000001a;
  --gjs-main-light-color: #ffffff1a;
  --gjs-secondary-light-color: #ffffffb3;
  --gjs-soft-light-color: #ffffff04;
...
.gjs-traits-c, .gjs-traits-cs, .gjs-trait-categories {
...
.gjs-resizing-cl *, .gjs-resizing-cr * {
...
.gjs-placeholder.horizontal, .gjs-com-placeholder.horizontal, .gjs-placeholder.horizontal {
  border-color: #0000 var(--gjs-placeholder-background-color);
  border-width: 3px 5px;
  margin: -3px 0 0;
}

.gjs-placeholder.vertical, .gjs-com-placeholder.vertical, .gjs-placeholder.vertical {
  border-color: var(--gjs-placeholder-background-color) #0000;
...
:is(.gjs-sm-field select:-moz-focusring, .gjs-clm-field select:-moz-focusring, .gjs-clm-select select:-moz-focusring) {
  color: #0000;
  text-shadow: 0 0 0 var(--gjs-secondary-light-color);
}
...
.gjs-layer-vis-off, .gjs-layer-vis.gjs-layer-off .gjs-layer-vis-on {
  display: none;
}
...
.gjs-mdl-active .gjs-mdl-dialog {
  animation: .216s gjs-mdl-slide-down;
}
...
.gjs-rte-action:hover, .gjs-rte-active {
  background-color: var(--gjs-main-light-color);
}
...
.sp-container button:active {
  ...
  box-shadow: inset 0 0 5px 2px #aaa, 0 1px #eee;
}
...
.gjs-one-color, .gjs-one-color-h:hover {
...
.gjs-two-color, .gjs-two-color-h:hover {
...
.gjs-three-color, .gjs-three-color-h:hover {
...
.gjs-danger-color, .gjs-danger-color-h:hover {
...
/*# sourceMappingURL=node_modules_grapesjs_dist_css_grapes_min_5f12f892.css.map*/